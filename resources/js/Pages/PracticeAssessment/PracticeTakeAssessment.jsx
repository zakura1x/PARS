                    ...
                    <div className="border p-4 rounded-md shadow w-[95%] bg-white">
                                ...
                                <div className="bg-gray-100 px-4 py-2 border-b flex justify-between items-center">
                                    ...
                                    {currentQuestion.question.attachment_path.match(
                                        ...
                                        <button
                                            onClick={() =>
                                                window.open(
                                                    `/storage/${currentQuestion.question.attachment_path}`,
                                                    "_blank"
                                                )
                                            }
                                ...
                                {["True", "False"].map((option, index) => (
                                    ...
                                    >
                                        <input
                                            ...
                                            id={`option-${index}`}
                                            value={option}
                                            className="radio radio-primary mr-3 h-5 w-5"
                                            onChange={() =>
                                                handleOptionChange(option)
                                            }
                                            checked={data.answers[
                        ...
                        {currentQuestion.question.format_type === "essay" && (
                            <div className="mt-6">
                                ...
                                <textarea
                                    className="textarea textarea-bordered w-full min-h-[200px] p-4 text-base"
                                    value={
