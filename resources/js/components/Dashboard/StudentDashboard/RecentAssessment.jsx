...
export function RecentAssessments({
    ...
    const handleExamClick = (assessmentId, studentId) => {
        router.get(
            route("assessment.student-result", {
    ...
    const handlePracticeClick = (practiceAssessmentId) => {
        router.get(
            route("practice-assessment.view-result", {
    ...
    return (
        <div className="w-full">
            <div className="tabs tabs-boxed mb-4">
                <a
                    className={`tab ${
                        activeTab === "examinations" ? "tab-active" : ""
                    }`}
                ...
                <a
                    className={`tab ${
                        activeTab === "practices" ? "tab-active" : ""
                    }`}
                            ...
                            {practices.length === 0 ? (
                                ...
                                practices.map((practice) => (
                                    ...
                                    >
                                        ...
                                        <td>
                                            {format(
                                                new Date(practice.submitted_at),
                                                "PPpp"
                                            )}
                                        </td>
                                        <td className="text-right">
