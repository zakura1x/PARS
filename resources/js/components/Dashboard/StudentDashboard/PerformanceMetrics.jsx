import {
  ...
  export function PerformanceMetrics({ metrics }) {
    // Ensure metrics object is populated and handle errors
    if (!metrics || !metrics.proficiency_distribution) return <div>Loading...</div>
    ...
    const scoreData = [
      ...
      { name: "Class Average", score: metrics.class_average || 72.5 }, // Use dynamic class average if available
    ]
